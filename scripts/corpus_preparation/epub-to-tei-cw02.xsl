...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <TEI xmlns="http://www.tei-c.org/ns/1.0">
            <teiHeader>
                <fileDesc>
                    <titleStmt>
                        <title type="main">Kindheitsmuster</title>
                        <title type="short">Kindheitsmuster</title>
                        <title type="idno">
                            <idno type="viaf">...</idno>
                        </title>
                        <author>
    ...
    <xsl:template match="p[@class=('calibre2','noindent','right','zitat-top')][normalize-space(.)!='']">
        <p>
            <xsl:apply-templates/>
        </p>
    </xsl:template>
    ...
    <xsl:template match="div[@class='poem']/p[@class='poem2'][normalize-space(.)!='']">
