...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <TEI xmlns="http://www.tei-c.org/ns/1.0">
            <teiHeader>
                <fileDesc>
                    <titleStmt>
                        <title type="main">Schöne Aussicht</title>
                        <title type="short">Aussicht</title>
                        <title type="idno">
                            <idno type="viaf">...</idno>
                        </title>
                        <author>
    ...
    <xsl:template match="p[@class=('p-blanc')][not(br[@class='calibre2'])]">
    ...
    <xsl:template match="p[@class=('p-d-blocktext', 'p-d-br', 'p3', 'p-c-box')]">
    ...
    <xsl:template match="p[@class='p-blanc'][br[@class='calibre2']]">
        <milestone rend="space" unit="section"/>
    </xsl:template>
    
    <xsl:template match="span[@class='i1']">
