...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- used for: Aus dem Tagebuch einer Schnecke (gg02) -->
    <!-- &nbsp; durch Leerzeichen 
    ...
    <xsl:template match="/">
        <TEI xmlns="http://www.tei-c.org/ns/1.0">
            <teiHeader>
                <fileDesc>
                    <titleStmt>
                        <title type="main">Aus dem Tagebuch einer Schnecke</title>
                        <title type="short">Schnecke</title>
                        <title type="idno">
                            <idno type="viaf">...</idno>
                        </title>
                        <author>
